...
const StudentSubjectItem = ({id, name, lessons}:StudentSubjectItemProps) =>{

    return(
        <div className="course_grid items-center bg-gray-100 rounded-xl shadow-2xl">
            ...
            <Link to={`/student/subject/lesson/${id}`} className="hover:text-blue-400">{name}</Link>
            <p>{lessons}</p>
        </div>
    )
}
